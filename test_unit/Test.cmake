...
# ===================================================================
   ...
   IF (FIPS_UNITTESTS)
      ...
      FOREACH(test ${tests_to_run} )
        ...
        gtest_begin(${test})
         ...
         IF(${test} STREQUAL "test_filechange")
          ...
          #     ${helper}
          #  )
           #add_executable(test_filechange )
         ELSE()
           #${g3log_SOURCE_DIR}/test_main/test_main.cpp
           fips_files(
              ${DIR_UNIT_TEST}/${test}.cpp
              ${helper}
          )
        ...
        ## Setting the equivalents of these using gtest_begin() hasn't been figured out...
    ...
    ## Disabled for now under transition to fips
    #
