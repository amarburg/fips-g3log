...
SET(LOG_SRC ${CMAKE_CURRENT_SOURCE_DIR}/src)
fips_include_directories(${LOG_SRC})
fips_include_directories("${CMAKE_BINARY_DIR}/include")
...
if( FIPS_IMPORT )
  SET_TARGET_PROPERTIES(${G3LOG_LIBRARY} PROPERTIES LINKER_LANGUAGE CXX )
else()
